...
#print("data_in", data_in, "data_in_length " , N.shape(data_in)[0])
#print(type(data_in))
# if header is read as data, use the following:
#data_in=data_in[1:]
#data_in = [[30, 30, 40]] # added by theodor
#print("data_in", data_in) # added by theodor
...
#        print(cursor) # added by theodor
        data=N.array(list(cursor))
        data=data.transpose()
#        print(data) # added by theodor
...
if args.predict:
    ...
    with DB(host=args.host, user=args.user, db_name=args.db, sqlite_path=args.sqlite) as db:
        ...
        T0=T.time()
#        print(T0) # added by theodor
        #IMPORTANT LINE!!!
        data_in_length = N.shape(data_in)[0] # added by theodor - good to go for models 2, 3, 4, 5
        ptf_model=PTF_MODEL(data_in_length - 1 , db)
#        print("ptf_model  : ######################################################", ptf_model.model_name) # added by theodor
