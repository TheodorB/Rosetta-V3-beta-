...
./Rpredict.py   -i   ./output/test_input_H2w.txt  -o  ./output/test_output_H2w.txt --predict  --sqlite=./sqlite/Rosetta.sqlite
...
./Rpredict.py   -i   ./output/test_input_H3w.txt  -o  ./output/test_output_H3w.txt --predict  --sqlite=./sqlite/Rosetta.sqlite
